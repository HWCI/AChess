...
namespace UnityEngine.UI
{
    ...
    public class BoxSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        protected override void OnValidate()
        {
            ...
            if (prefabType != PrefabAssetType.Regular && !Application.isPlaying)
        ...
        private void UpdateDrag(PointerEventData eventData, Camera cam)
        {
            ...
            if (clickRect != null && clickRect.rect.size[0] > 0)
            {
                ...
                var val = Mathf.Clamp01((localCursor - m_Offset)[0] / clickRect.rect.size[0]);
                normalizedValue = val;

                var valY = Mathf.Clamp01((localCursor - m_Offset)[1] / clickRect.rect.size[1]);
