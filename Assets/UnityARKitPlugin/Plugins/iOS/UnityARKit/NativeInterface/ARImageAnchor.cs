...
namespace UnityEngine.XR.iOS
{
    ...
    {
        private readonly UnityARImageAnchorData imageAnchorData;
        ...
        {
            get { return Marshal.PtrToStringAuto(imageAnchorData.ptrIdentifier); }
        }

        public bool isTracked
        {
            get { return imageAnchorData.isTracked != 0; }
        }
        ...
        {
            get { return Marshal.PtrToStringAuto(imageAnchorData.referenceImageNamePtr); }
        }

        public float referenceImagePhysicalSize
        {
            get { return imageAnchorData.referenceImagePhysicalSize; }
        }
    }
}