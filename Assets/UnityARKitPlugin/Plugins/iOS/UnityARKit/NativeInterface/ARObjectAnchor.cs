...
namespace UnityEngine.XR.iOS
{
    ...
    {
        private readonly UnityARObjectAnchorData objectAnchorData;
        ...
        {
            get { return Marshal.PtrToStringAuto(objectAnchorData.ptrIdentifier); }
        }
        ...
        {
            get { return Marshal.PtrToStringAuto(objectAnchorData.referenceObjectNamePtr); }
        }

        public IntPtr referenceObjectPtr
        {
            get { return objectAnchorData.referenceObjectPtr; }
        }
    }
    ...
    public partial class UnityARSessionNativeInterface
    {
        ...
        private delegate void internal_ARObjectAnchorAdded(UnityARObjectAnchorData anchorData);

        private delegate void internal_ARObjectAnchorUpdated(UnityARObjectAnchorData anchorData);

        private delegate void internal_ARObjectAnchorRemoved(UnityARObjectAnchorData anchorData);
