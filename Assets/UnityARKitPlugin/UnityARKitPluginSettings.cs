...
{
	/// <summary>
	///     Toggles whether ARKit is required for this app: will make app only downloadable by devices with ARKit support if
	///     enabled.
	/// </summary>
	[Tooltip(
	...
	/// <summary>
	///     Toggles whether Facetracking for iPhone X (and later) is used. If enabled, provide a Privacy Policy for submission
	///     to AppStore.
	/// </summary>
	[Tooltip(
