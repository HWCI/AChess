...
public class QueryAnimationController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject queryBodyParts;

    [SerializeField] private GameObject[] queryHandParts;
    ...
    public void ChangeAnimation(QueryChanAnimationType animNumber)
    {
        switch (animNumber)
        {
            ...
            case QueryChanAnimationType.FLY_UP:
                ...
                GetComponent<QueryEmotionalController>()
                    .ChangeEmotion(QueryEmotionalController.QueryChanEmotionalType.NORMAL_EYEOPEN_MOUTHCLOSE);
                break;
            ...
            case QueryChanAnimationType.FLY_ITEMGET_LOOP:
                ...
                GetComponent<QueryEmotionalController>()
                    .ChangeEmotion(QueryEmotionalController.QueryChanEmotionalType.FUN_EYECLOSE_MOUTHOPEN);
                break;

            case QueryChanAnimationType.FLY_DAMAGE:
                changeHandPart(QueryChanHandType.NORMAL);
                GetComponent<QueryEmotionalController>().ChangeEmotion(QueryEmotionalController.QueryChanEmotionalType
                    .SURPRISED_EYEOPEN_MOUTHOPEN_MID);
                break;
            ...
            case QueryChanAnimationType.FLY_DISAPPOINTMENT_LOOP:
                changeHandPart(QueryChanHandType.STONE);
                GetComponent<QueryEmotionalController>()
                    .ChangeEmotion(QueryEmotionalController.QueryChanEmotionalType.SAD_EYECLOSE_MOUTHOPEN);
                break;
        ...
        var targetAnimations = new List<string>();
    ...
    {
        foreach (var targetHandPart in queryHandParts) targetHandPart.SetActive(false);
